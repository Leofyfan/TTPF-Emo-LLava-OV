...
def train(attn_implementation=None):
    ...
    model_name_or_path = "/root/autodl-tmp/llava-hf/llava-onevision-qwen2-0.5b-ov-hf"     

    PREV_STAGE_CHECKPOINT = "/root/autodl-tmp/llava-hf/llava-onevision-qwen2-0.5b-ov-hf"
